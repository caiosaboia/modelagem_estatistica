Professor, para o quarto funcionar devidamente, há muitos passos. Vou deixar alguns detalhes:
...
- Ou apenas usar o **main.pdf** que eu conseguir resolver um problema de compilação hehe.
